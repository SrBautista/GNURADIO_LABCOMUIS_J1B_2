...
class ModuladorAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._offset_range = Range(-10, 10, 1e-3, 0, 200)
        self._offset_win = RangeWidget(self._offset_range, self.set_offset, "A1", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._b_range = Range(-1, 1, 1, 1, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm, am, offset, 0)
        self.SSB_0 = SSB(
            Ac=ac,
            B=b,
            K=1,
        ...
        # Connections
        ##################################################
        self.connect((self.SSB_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.SSB_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.CalculoPotenciaComunicaciones_0_0, 0))
