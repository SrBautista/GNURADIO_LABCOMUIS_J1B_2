...
class PruebaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "PAM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PAM")
        ...
        self.uhd_usrp_sink_0.set_center_freq(5e7, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.Modulacion_0, 0), (self.blocks_float_to_complex_0, 0))
        self.connect((self.Modulacion_0, 0), (self.qtgui_freq_sink_x_0, 0))
