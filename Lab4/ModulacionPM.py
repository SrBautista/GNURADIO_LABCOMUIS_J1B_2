...
from PM import PM  # grc-generated hier_block
...
class ModulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganancia del trasmisor", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        # Connections
        ##################################################
        self.connect((self.PM_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.PM_1, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.PM_1, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.PM_1, 0))
