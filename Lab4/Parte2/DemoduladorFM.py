...
class DemoduladorFM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._ga_win = RangeWidget(self._ga_range, self.set_ga, "Ganacia radio", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_fm_preemph_0 = analog.fm_preemph(fs=2e5, tau=75e-6, fh=-1.0)
        self._GRX_range = Range(0, 30, 1, 0, 200)
        self._GRX_win = RangeWidget(self._GRX_range, self.set_GRX, "Ganacia RX", "counter_slider", float, QtCore.Qt.Horizontal)
